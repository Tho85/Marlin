Marlin for Daycom 3DP-100
=========================

This repository contains the firmware source for the [Daycom 3DP-100](https://www.pollin.de/p/3d-drucker-daycom-3dp-100-b-ware-703230) printer. It is based on a [fork of Marlin by makerlab.me](https://github.com/MakerLabMe/Marlin), the manufacturer of the printer's controller.

The original manufacturer (Daycom / Pollin) provides the source code by mail if you ask politely. I used that as a base to reconstruct this repository, and I explicitely included all changes they made, including typos and CRLF line endings.

Please note that I'm neither affiliated with Daycom, Pollin or makerlab.me in any way, nor did I contribute to the development of the firmware. I'm just a happy user / hacker / whatever.

EEPROM contents
---------------

This is the contents of EEPROM, as generated by GCode [M503](https://github.com/MarlinFirmware/Marlin/wiki/M503):

```
Send: M503
Recv: echo:Steps per unit:
Recv: echo:  M92 X80.00 Y80.00 Z800.00 E94.30
